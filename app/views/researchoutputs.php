...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="researchoutputs">Admin</a></li>
          <li class="breadcrumb-item active">Research Outputs</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
                <br>
              <h5>Upload Research Paper</h5> <hr>
            ...
            <form>
                ...
                <div class="row mb-3">
                  <label for="inputEmail" class="col-sm-2 col-form-label">Author/s</label>
                  <div class="col-sm-10">
