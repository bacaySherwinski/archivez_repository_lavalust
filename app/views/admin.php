    ...
    <section class="section dashboard">
      <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Recent Uploads <span>| Today</span></h5>
        ...
        <div class="col-lg-4">
          ...
          <!-- Research Paper Status Report -->
          <div class="card">

            <div class="card-body pb-0">
              <h5 class="card-title">Research Paper Analytics</h5>
          ...
          </div><!-- End Research Paper Status Report -->

          <!-- Website Traffic -->
          <div class="card">

            <div class="card-body pb-0">
              <h5 class="card-title">Research Paper Status Report</h5>
